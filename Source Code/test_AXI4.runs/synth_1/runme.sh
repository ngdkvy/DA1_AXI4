...
HD_PWD='D:/Vy/university/formal/N3 - HK2/Project 1/Code/Code/test_AXI4/test_AXI4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI4_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI4_TOP.tcl

...
HD_PWD='D:/Vy/university/formal/N3 - HK2/Project 1/Code/Code/test_AXI4/test_AXI4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI4_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI4_TOP.tcl -notrace
